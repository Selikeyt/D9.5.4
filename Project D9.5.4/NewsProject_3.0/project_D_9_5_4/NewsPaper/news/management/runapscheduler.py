...
def my_job():
    ...
    subscribers = set(Subscription.objects.filter(category__name_category__in=categories).values_list('subscribers__email',
                                                                                                      flat=True))
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            my_job,
            trigger=CronTrigger(day_of_week='mon', hour='19', minute='17'),
